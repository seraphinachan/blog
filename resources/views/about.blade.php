				...
				<div class="row">
					<div class="col-md-7">
						<div class="about-desc">
							<div class="about-img-1 animate-box" style="background-image: url(blog_template/images/img_bg_1.jpg);"></div>
							<div class="about-img-2 animate-box" style="background-image: url(blog_template/images/img_bg_2.jpg);"></div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="row">
